...
static class Icon
{
    ...
    public const string GlobeWifi = "\ue685";
    public const string Hydra = "\ue686";
    public const string LightbulbMessage = "\ue687";
    public const string Octopus = "\ue688";
    public const string UserBeardBolt = "\ue689";
    public const string UserHoodie = "\ue68a";
    public const string Diamonds4 = "\ue68b";
    public const string ThumbtackSlash = "\ue68f";
    public const string TableCellsColumnUnlock = "\ue690";
    public const string TableCellsRowUnlock = "\ue691";
    public const string TableCellsUnlock = "\ue692";
